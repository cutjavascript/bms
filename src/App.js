...
const App = () => (
  ...
  <div className="App container" style={{backgroundColor: "#f8f8f8",minWidth: 1400,padding: 0}}>
            ...
            <div className="row" style={{marginTop: 28}}>
              <div className="col-sm-2">
                <div className="component component-Label" style={{textAlign: "right",height: 38}}>
                  ...
                  <label  style={{whiteSpace: "nowrap",fontSize: 28,fontWeight: 700,fontStyle: "normal",fontFamily: '"Segoe UI"',color: "rgb(255, 0, 0)"}}>#BMS</label>
                  </div>
                </div>
              </div>
              ...
              <div className="col-sm-6">
                <div className="">
                    <input type="text" placeholder="Search Your Studios"  style={{width: "100%",height: 40,borderWidth: "inherit",borderStyle: "none",borderColor: "rgb(204, 0, 51)",borderImage: "initial",paddingLeft: 7,paddingRight: 2,margin: 0,boxSizing: "border-box",outline: "none",lineHeight: 38,textAlign: "left",fontSize: 14,fontWeight: 400,fontStyle: "normal",textDecoration: "none",fontFamily: '"Segoe UI"',color: "rgb(102, 102, 102)",backgroundColor: "rgb(242, 242, 242)",borderRadius: 5}} />
                </div>
              </div>
              <div className="col-sm-4" style={{lineHeight: "49px"}}>
                <label className="menu-label">Help</label>
                <label className="menu-label"><Link to={'/studio/neelam'}>My Account</Link></label>
    ...
    <section className="container-body">
      ...
      <div className="col-sm-4" style={{height: "49px"}}></div>
    </section>
  </div>
  </Router>
  </Provider>
