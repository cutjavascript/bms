                  ...
                  <label className="menu-label">
                    <a href="#" style={{ textDecoration: 'none', color: '#666666' }}>
                      ...
                      <img
                        ...
                        style={{ width: 32, height: 32, border: '2px solid #c4c4c4', borderRadius: 17, marginLeft: 5 }}
                      />
                    </a>
          ...
          <footer>
            ...
            >
              <div className="component component-TextArea" style={{ textAlign: 'center', paddingTop: 40 }}>
                ...
                >
                  <p style={{ textAlign: 'center', textDecoration: 'none' }}>
                    <span> About BMS.com | Terms of Use | Privacy Policy | Home | Add Post | Blogs </span>
                  </p>
                </div>
              </div>
              <div
                ...
                >
                  ...
                  >
                    <div style={{ textAlign: 'center', overflow: 'hidden', lineHeight: 'inherit' }}>
                      ...
                      >
                        <span>
                          BMS.com is India's largest network of most trusted Music Recording Studios. Over 50 lakh
                          customers rely on BMS.com, to fulfill their Studio requirements across 1,000+ Using BMS.com,
                          You can compare multiple Studios and choose the one that best suits their requirements. Read
                          more
                        </span>
                      </p>
                    </div>
              ...
              <div className="component component-TextArea" style={{ textAlign: 'center', paddingTop: 10 }}>
                ...
                >
                  <p style={{ textAlign: 'center', textDecoration: 'none' }}>
                    <i className="fa fa-facebook-square fa-2x" style={{ padding: 5 }} />
                    <i className="fa fa-twitter-square fa-2x" style={{ padding: 5 }} />
                    <i className="fa fa-google-plus-square fa-2x" style={{ padding: 5 }} />
                  </p>
                </div>
              </div>
            </div>
